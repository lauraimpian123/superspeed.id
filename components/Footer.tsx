...
export default function Footer() {
  return (
    <footer className="relative bg-[#0A0A0A] border-t border-[#F5A623]/10">
      {/* Top accent line */}
            ...
            <div className="flex gap-4">
              {["instagram", "youtube", "twitter", "facebook"].map((social) => (
                <a
                  key={social}
                  href="#"
                  className="w-10 h-10 rounded border border-[#F5A623]/20 flex items-center justify-center text-gray-400 hover:text-[#F5A623] hover:border-[#F5A623]/60 hover:bg-[#F5A623]/5 transition-all duration-300"
                  aria-label={social}
                >
